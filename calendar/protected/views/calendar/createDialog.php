...
<div id="create-container" class="form">
	...
	<div class="borderedRow" id="rowBody">
		...
		<div class="tabbody" id="event">
			<?php $this->renderPartial('create/event',array('model'=>$model,'form'=>$form),false,true); ?>
		</div>

		<div class="tabbody" id="repeat">
			<?php $this->renderPartial('create/repeat',array('model'=>$model,'form'=>$form),false,true); ?>
		</div>

		<div class="tabbody" id="guest">
			<?php $this->renderPartial('create/guest',array('model'=>$model,'form'=>$form),false,true); ?>
		</div>

		<div class="tabbody" id="remainder">
			<?php $this->renderPartial('create/remainder',array('model'=>$model,'form'=>$form),false,true); ?>
		</div>
